...
export const GuestTransactionsTable = () => {
  ...
  return (
    <div className="flex flex-col h-full">
      ...
      <div className="flex justify-between items-center bg-slate-800/30 mb-4 p-4 border border-slate-700 rounded-lg">
        <DateColumnFilter
          startDate={startDate}
          endDate={endDate}
      ...
      {guestTransactions.length === 0 ? (
        <div className="flex flex-col flex-1 justify-center items-center bg-slate-800/20 border-2 border-slate-700/50 border-dashed rounded-xl">
