...
export const CustomerDetailHeader = () => {
  ...
  return (
    // Matched styling exactly: p-2 px-8, border-b, backdrop-blur, etc.
    // Removed 'h-fit' here because the parent layout now controls the flow,
    // but keeping 'min-h-[80px]' ensures consistent size.
